  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (endorseData["Action"] == "endorse") {
        ...
        const data = await submitForm(
          "/submitslmp/transfer/section2-reject",
          endorseData
        );
  ...
  return (
    <div style={{ margin: "1rem" }}>
      ...
      <form onSubmit={handleSubmit} className="row g-3">
        ...
        <div className="col-md-4">
          <label htmlFor="selectVSP" className="form-label">
            Vendor Software Portal Updated?
          </label>
          <div className="form-check">
            <input
              className="form-check-input"
              ...
              required
            />
            <label className="form-check-label" htmlFor="yesVSPUpdated">
              Yes
            </label>
          </div>
          <div className="form-check">
            <input
              ...
              required
            />
            <label className="form-check-label" htmlFor="noVSPUpdated">
              No
            </label>
          </div>
        </div>
